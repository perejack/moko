  ...
  <div className="min-h-screen bg-[#fbeee6] flex flex-col">
    ...
    <main className="flex-1 max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="mb-4">
        ...
        <a
          href={`https://wa.me/254753818138?text=${encodeURIComponent('Hi MoKo! I want to Lipia Polepole for the Pouff at KSh 2,599 (Quantity: 1)')}`}
          target="_blank"
      ...
      <a
        href={`https://wa.me/254753818138?text=${encodeURIComponent('Hi MoKo! I want to order the Pouff at KSh 2,599 (Quantity: 1)')}`}
        target="_blank"
        rel="noopener noreferrer"
