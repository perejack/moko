        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2 flex flex-col">
            ...
            <div className="flex flex-col gap-4 mt-6">
              <a
                href={`https://wa.me/254755335197?text=Hi%20MoKo!%20I%20want%20to%20order%20the%20${encodeURIComponent(carpet.title)}%20for%20${encodeURIComponent(carpet.price)}%20(Quantity:%20${quantity})`}
                target="_blank"
              ...
              <a
                href={`https://wa.me/254755335197?text=Hi%20MoKo!%20I%20want%20to%20Lipia%20Polepole%20for%20the%20${encodeURIComponent(carpet.title)}%20at%20${encodeURIComponent(carpet.price)}%20(Quantity:%20${quantity})`}
                target="_blank"
                rel="noopener noreferrer"
