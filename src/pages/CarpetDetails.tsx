...
const CarpetDetails = () => {
  ...
  const [carpet, setCarpet] = React.useState<Product | null>(null);
  ...
  if (error || !carpet) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col">
        <Header />
        <main className="flex-1 max-w-5xl mx-auto px-4 py-10">
          <div className="text-center text-2xl text-gray-700">{error || 'Carpet not found.'}</div>
        </main>
        <Footer />
        <ChatButton />
      </div>
