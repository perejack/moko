      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 py-10">
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2 flex flex-col">
            ...
            <a
              href={`https://wa.me/254753818138?text=Hi%20MoKo!%20I%20want%20to%20order%20the%20${encodeURIComponent(coffeeTable.title)}%20for%20${encodeURIComponent(coffeeTable.price)}%20(Quantity:%20${quantity})`}
              target="_blank"
            ...
            <a
              href={`https://wa.me/254753818138?text=Hi%20MoKo!%20I%20want%20to%20Lipia%20Polepole%20for%20the%20${encodeURIComponent(coffeeTable.title)}%20at%20${encodeURIComponent(coffeeTable.price)}%20(Quantity:%20${quantity})`}
              target="_blank"
              rel="noopener noreferrer"
