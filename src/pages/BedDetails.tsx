...
const BedDetails = () => {
  ...
  const product = beds.find((b) => b.slug === slug);
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center">
          <div className="text-center">
            <h2 className="text-2xl font-semibold mb-4">Bed Not Found</h2>
            <Link to="/beds" className="text-[#F37021] underline">Back to Beds</Link>
          </div>
        </main>
        <Footer />
        <ChatButton />
  ...
  // Dynamic options for each product
  const fabricOptions = product.slug === 'zzze-hug-headboard-cushion'
    ? ['Gray', 'Blue', 'Brown']
    : ['None'];
  const bedSizeOptions = product.slug === 'zzze-hug-moko-bed'
    ? ['6 by 6 (King)', '5 by 6 (Queen)', '4 by 6', '3.5 by 6', '3 by 6']
    : ['Choose an option'];

  // WhatsGood/Badges for each product
  const whatsGood = product.slug === 'zzze-hug-headboard-cushion'
    ? [
  ...
  const description = product.slug === 'zzze-hug-headboard-cushion'
    ? (
      <>
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 py-10">
        ...
        <nav className="text-sm text-gray-500 mb-4">
          ...
          <Link to="/beds" className="hover:underline">Beds</Link> /{' '}
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="md:w-1/2 flex flex-col">
            ...
            <div className="text-xl text-[#F37021] font-semibold mb-2">{product.priceRange}</div>
            ...
            {/* Option selectors */}
            {product.slug === 'zzze-hug-headboard-cushion' && (
              <div className="mb-4">
            ...
            {product.slug === 'zzze-hug-moko-bed' && (
              <div className="mb-4">
            ...
            <div className="flex flex-col gap-4 mt-6">
              ...
              />
              <a
                href={`https://wa.me/254753818138?text=Hi%20MoKo!%20I%20want%20to%20order%20the%20${encodeURIComponent(product.title)}%20for%20${encodeURIComponent(product.priceRange)}%20(Quantity:%20${quantity})`}
                target="_blank"
              ...
              <a
                href={`https://wa.me/254753818138?text=Hi%20MoKo!%20I%20want%20to%20Lipia%20Polepole%20for%20the%20${encodeURIComponent(product.title)}%20at%20${encodeURIComponent(product.priceRange)}%20(Quantity:%20${quantity})`}
                target="_blank"
                rel="noopener noreferrer"
